 ...
 *******************************************************************************/
package io.openliberty.session.internal;
...
import io.openliberty.session.internal.http.HttpSessionImpl60;
...
public class SessionData60 extends HttpSessionImpl60 {
    ...
    protected AbstractHttpSessionFacade returnFacade() {
        if (com.ibm.ejs.ras.TraceComponent.isAnyTracingEnabled() && LoggingUtil.SESSION_LOGGER_CORE.isLoggable(Level.FINER)) {
            LoggingUtil.SESSION_LOGGER_CORE.log(Level.FINE, "SessionData60" + "returnFacade HttpSessionFacade60");
        }
