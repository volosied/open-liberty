...
Subsystem-Name: Jakarta Server Faces 2.3
...
-bundles=com.ibm.ws.org.apache.myfaces.2.3, \
 ...
 com.ibm.websphere.javaee.websocket.1.1.jakarta; apiJar=false; location:="dev/api/spec/,lib/"; mavenCoordinates="javax.websocket:javax.websocket-api:1.1", \
