...
public class ResourceHandlerImpl extends ResourceHandler
{
            ...
            String contentType)
    {
        ...
        {
            System.out.println("DEBUG -- "+this+" createResource returning null"  );
            return null;
        }
        ...
        else
        {
            ...
            if (!resolved)
            {
                ...
                System.out.println("DEBUG -- "+this+" createResource returning ---> " + resource );
        return resource;
    }
    ...
    public void handleResourceRequest(FacesContext facesContext) throws IOException
    {
        ...
        //{
            ...
            System.out.println("DEBUG -- handleResourceRequest for resourceBasePath: " + resourceBasePath );
            ...
            if (resourceBasePath.startsWith(ResourceHandler.RESOURCE_IDENTIFIER))
            {
                ...
                System.out.println("DEBUG -- handleResourceRequest for resourceName: " + resourceName );
            ...
            if (libraryName != null)
            {
                System.out.println("DEBUG -- "+ this +" libraryName=" + libraryName);
                resource = facesContext.getApplication().getResourceHandler().createResource(resourceName, libraryName);
            }
            else
            {
                System.out.println("DEBUG -- "+ this +" libraryName = null");
            ...
            if (resource == null)
            {
                ...
                System.out.println("DEBUG -- "+ this +" handleResourceRequest for resource: " + resource.getClass() );
                try {
                    System.out.println("DEBUG -- "+ this +" handleResourceRequest for resource: " + resource.getClass() );
                    System.out.println("DEBUG -- "+ this +" handleResourceRequest for getResourceName: " + resource.getResourceName());
                } catch(NullPointerException e) {
                    System.out.println("DEBUG -- "+ this +" -- NPE caught.");
                }
