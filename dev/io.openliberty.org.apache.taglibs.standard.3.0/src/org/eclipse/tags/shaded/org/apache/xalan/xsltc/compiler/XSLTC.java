...
public final class XSLTC {
     ...
     */
    public XSLTC() {
        System.out.println("Using bad thing const!!");
     ...
     */
    public void init() {
        System.out.println("Using bad thing init!!");
	reset();
	_reader = null;
	_classes = new Vector();
     ...
     */
    private void reset() {
        System.out.println("Using bad thing reset!!");
    ...
    public boolean compile(InputSource input, String name) {
        Thread.dumpStack();
        System.out.println("Using bad thing compile!!");
	try {
    ...
    public void outputToJar() throws IOException {
        Thread.dumpStack();
        System.out.println("Using bad thing outjar!!");
	// create the manifest
