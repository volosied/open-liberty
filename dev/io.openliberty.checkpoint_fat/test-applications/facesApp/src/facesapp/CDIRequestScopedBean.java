...
public class CDIRequestScopedBean implements Serializable {
    ...
    @PostConstruct
    public void start() {
        System.out.println("CDIRequestScopedBean postConstruct called");
        this.data += ":PostConstructCalled:";
        if (ejb != null && ejb.verifyPostConstruct())
            this.data += ":EJB-injected:";
        if (defaultExec != null)
            this.data += ":Resource-injected:";
        System.out.println("CDIRequestScopedBean data is: " + data);
    }

    @PreDestroy
    public void stop() {
        System.out.println("CDIRequestScopedBean preDestroy called.");
    }
