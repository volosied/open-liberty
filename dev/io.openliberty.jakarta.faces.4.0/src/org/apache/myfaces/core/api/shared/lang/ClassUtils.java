...
public class ClassUtils
{
    ...
    public static <T> Class<T> classForName(String type, ClassLoader cl) throws ClassNotFoundException
    {
        Assert.notNull(type, "type");
    ...
    public static Class simpleClassForName(String type, ClassLoader cl)
    {
        return simpleClassForName(type, true, cl);
    }
    /**
    ...
    public static Class simpleClassForName(String type, boolean logException, ClassLoader cl)
    {
        Class returnClass = null;
        try
        {
            returnClass = classForName(type, cl);
        }
        catch (ClassNotFoundException e)
        {
            if (logException)
    ...
    public static Object newInstance(String type) throws FacesException
    {
        ...
        return newInstance(simpleClassForName(type)); // VS1
    }


    public static Object newInstance(String type, ClassLoader cl) throws FacesException
    {
        if (type == null)
        {
            return null;
        }
        return newInstance(simpleClassForName(type, cl));
    }
    ...
    public static <T> T newInstance(Class<T> clazz, ClassLoader cl) throws FacesException
    {
