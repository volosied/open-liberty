...
import cdi.beans.TestCustomBean;
import cdi.beans.injected.ConstructorBean;
import cdi.beans.injected.FieldBean;
import cdi.beans.injected.ManagedBeanType;
import cdi.beans.injected.MethodBean;
import cdi.interceptors.TestCustomResolver;
...
public class CustomELResolver extends ELResolver {
    ...
    public Object getValue(ELContext context, Object base, Object property) {
        ...
        String outcome = null;
        if (base != null) {
            if (base != null && base.getClass().getName().equals("cdi.beans.TestCustomBean")) {
