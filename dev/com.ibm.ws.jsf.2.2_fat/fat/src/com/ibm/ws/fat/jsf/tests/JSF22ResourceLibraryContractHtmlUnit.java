...
public class JSF22ResourceLibraryContractHtmlUnit {
    ...
    private HtmlPage getPageForURL(String contextRoot, String urlSubstring) throws GeneralSecurityException, FailingHttpStatusCodeException, MalformedURLException, IOException, Exception {
