...
public class JSF22AppConfigPopTests {
    ...
    public TestName name = new TestName();
        ...
        public static void setup() throws Exception {
            ...
            JavaArchive jar = ShrinkHelper.buildJavaArchive("JSF22AppConfigPop.jar", "AppConfigPopJar");

            WebArchive war = ShrinkHelper.buildDefaultApp("JSF22AppConfigPop.war", "AppConfigPop");
