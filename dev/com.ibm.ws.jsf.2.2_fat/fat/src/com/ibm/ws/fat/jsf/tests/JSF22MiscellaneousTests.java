...
public class JSF22MiscellaneousTests {
    ...
    public static void setup() throws Exception {
        ...
        EnterpriseArchive ear = ShrinkWrap.create(EnterpriseArchive.class, "JSF22Miscellaneous.ear");

        JSF22MiscellaneousWar.addAsLibraries(JSF22MiscellaneousJar);
        SerializeWar.addAsLibraries(JSF22MiscellaneousJar);
        ear.addAsModule(JSF22MiscellaneousWar);
        ear.addAsModule(SerializeWar);

        ShrinkHelper.addDirectory(ear, "test-applications" + "/JSF22Miscellaneous.ear" + "/resources");

        ShrinkHelper.exportDropinAppToServer(jsf22MiscellaneousServer, ear);
