...
public class JSF22APARSeleniumTests {
    ...
    public void testPH55398() throws Exception {
            ...
            ajaxButton.click();
            page.waitForPageToLoad(java.time.Duration.ofMillis(4000));

            // check for form1:ajaxbtn : Ajax Submit
            assertTrue(page.isInPageTextReduced("form1:ajaxbtn : Ajax Submit"));
            ...
            assertTrue(page.isInPageTextReduced("form1:nonajaxbtn : Non Ajax Submit"));
