...
public class JSFInjectionClassListCollaborator implements WebAppInjectionClassListCollaborator {
    ...
    private final String[] _InjectionSubClasses = new String[] {
        ...
        //"jakarta.faces.view.ViewDeclarationFactory",
        // assuming jakarta.faces.view.ViewDeclarationLanguageFactory instead
        "jakarta.faces.view.ViewDeclarationLanguageFactory",
        "jakarta.faces.view.facelets.FaceletCacheFactory",
        // In JSF 2.2 spec but not in API jar:
        // "jakarta.faces.view.facelets.FaceletFactory"
        // so ignored.
    ...
    public List<String> getInjectionClasses(Container moduleContainer) {
        ...
        // First try and find all classes with @jakarta.faces.bean.ManagedBean
        try {
            ...
            // jakarta.faces.bean.ManagedBean is inherited: use the 'all' version of the selector.
            Set<String> managedBeanClassNames = annoTargets.getAllInheritedAnnotatedClasses("jakarta.faces.bean.ManagedBean");
    ...
    /**
     * Look at the web.xml for a context-param jakarta.faces.CONFIG_FILES, and treat as a comma delimited list
     */
