...
public abstract class WebContainer extends BaseContainer {
    ...
    protected static int loadedContainerSpecLevel = loadServletSpecVersion();
    ...
    protected static int loadServletSpecVersion() {
        String methodName = "loadServletSpecVersion";

        String capabiltityVersion = "2.6.0"; // Default -- Servlet 3.0
       try {
            ...
            // Also catches NPE in unit tests since no bundles are active
