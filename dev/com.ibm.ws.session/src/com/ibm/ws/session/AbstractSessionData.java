...
public abstract class AbstractSessionData extends AbstractHttpSession implements IBMSessionExt {
    ...
    protected AbstractHttpSessionFacade _httpSessionFacade;
    ...
    protected void createFacade(AbstractHttpSessionFacade sessionFacade) {
        _httpSessionFacade = sessionFacade;
        
        if (TraceComponent.isAnyTracingEnabled() && LoggingUtil.SESSION_LOGGER_CORE.isLoggable(Level.FINE)) {
            LoggingUtil.SESSION_LOGGER_CORE.logp(Level.FINE, methodClassName, "createFacade", "_httpSessionFacade [[" + _httpSessionFacade + "]].  getClass [["+ _httpSessionFacade.getClass() +"]]");
        }
    }
}
