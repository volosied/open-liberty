...
public class TsxRepeatOptimizedTag implements OptimizedTag {
    ...
    public void generateDeclarations(OptimizedTagContext context) {
        ...
        context.writeDeclaration("createIndexMgr",
                                 "private void createIndexMgr(PageContext " + pageContextVar + ") {\n" +
                                                   ...
                                                   "        " + pageContextVar
                                                   + ".setAttribute(\"TSXDefinedIndexManager\", new com.ibm.ws.jsp.tsx.tag.DefinedIndexManager(), PageContext.PAGE_SCOPE);\n" +
                                                   "    }\n" +
                                                   "}");
        //PK65013 change pageContext variable to customizable one.
    ...
    public void generateStart(OptimizedTagContext context) {
        ...
        //PK65013 change pageContext variable to customizable one.
        context.writeSource("((com.ibm.ws.jsp.tsx.tag.DefinedIndexManager) " + pageContextVar + ".getAttribute(\"TSXDefinedIndexManager\", PageContext.PAGE_SCOPE)).addIndex(\""
                            + index + "\");");
        ...
        context.writeSource("    ((java.util.Hashtable)" + pageContextVar + ".getAttribute(\"TSXRepeatLookup\", PageContext.PAGE_SCOPE)).put(\"" + index + "\", new Integer("
                            + index + "));");
    ...
    public void generateEnd(OptimizedTagContext context) {
        ...
        context.writeSource("((com.ibm.ws.jsp.tsx.tag.DefinedIndexManager) " + pageContextVar + ".getAttribute(\"TSXDefinedIndexManager\", PageContext.PAGE_SCOPE)).removeIndex(\""
                            + index + "\");");
    }
