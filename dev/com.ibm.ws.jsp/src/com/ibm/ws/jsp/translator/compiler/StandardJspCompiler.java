    ...
    public String getJspLineErrors(Collection jspLineIds) {
        ...
        for (Diagnostic<? extends JavaFileObject> diagnostic : diagnostics.getDiagnostics()) {
            if (diagnostic.getKind().equals(javax.tools.Diagnostic.Kind.ERROR) || (isVerbose || isDeprecation)) {
                ...
                String mapping = diagnostic.getSource() == null ? null : findMapping(jspLineIds, diagnostic.getLineNumber(),
                                                                                     new File(diagnostic.getSource().toUri().getSchemeSpecificPart()).getPath());
