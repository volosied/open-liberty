    ...
    public void endGeneration(int section, JavaCodeWriter writer) throws JspCoreException {
        if (section == CodeGenerationPhase.METHOD_SECTION) {
            ...
            if (isTagFile || isFragment) {
                ...
                writer.println("throw new com.ibm.ws.jsp.runtime.WsSkipPageException(\"Tag file or fragment returned from forward to [" + page.replace('\"', '\'')
                               + "]. Remainder of page not evaluated\");");
