...
public class JspPageParser {
    ...
    protected void processAction() throws IOException, JspCoreException {
        ...
        if (inName && (actionPrefix.equals("jsp") || tagPrefixes.containsKey(actionPrefix))) {
            ...
            if (endOfFile) {
                throw new JspCoreException("jsp.error.end.of.file.reached", new Object[] {
                ...
                if (isEndTag) {
                    ...
                    if (element.getPrefix().equals(actionPrefix) && element.getLocalName().equals(actionName)) {
                        ...
                        if (jspOptions.isAllowUnmatchedEndTag()) {
                            ...
                            throw new JspCoreException("jsp.error.unmatched.end.tag", new Object[] { element.getNodeName(), actionPrefix + ":" + actionName,
                                                                                                     "[" + currentLineNum + "," + currentColumnNum + "]" });
                        }
                        //PK30879 end
                    }
                } else {
    ...
    protected boolean processActionAttributes(Element actionElement) throws IOException, JspCoreException {
        ...
        while (endFound == false) {
            ...
            switch (character) {
                case -1: {
                    throw new JspCoreException("jsp.error.end.of.file.reached", new Object[] { actionElement.getNodeName(),
                                                                                               "Line: " + jspSyntaxLineNum + " Col: " + jspSyntaxColNum });
                }
                case '>': {
                    if (inValue == false) {
    ...
    protected void processHtmlCommment() throws IOException, JspCoreException {
        ...
        while (endFound == false) {
            ...
            switch (character) {
                case -1: {
                    throw new JspCoreException("jsp.error.end.of.file.reached", new Object[] { "html comment " + htmlCommentText.toString(),
                                                                                               "Line: " + jspSyntaxLineNum + " Col: " + jspSyntaxColNum });
                }
    ...
    protected void processDirective() throws IOException, JspCoreException {
        ...
        while (endFound == false) {
            ...
            switch (character) {
                case -1: {
                    throw new JspCoreException("jsp.error.end.of.file.reached", new Object[] { "directive " + directive.toString(),
                                                                                               "Line: " + jspSyntaxLineNum + " Col: " + jspSyntaxColNum });
                }
                    ...
                    if (inDirective && directive.toString().trim().length() > 0) {
                        if (directive.toString().equals("taglib") == false && directive.toString().equals("include") == false) {
                            ...
                            try {
                                ...
                                throw new JspCoreException("jsp.error.unable.to.create.xml.element", new Object[] { Constants.JSP_NAMESPACE,
                                                                                                                    "jsp:directive." + directive.toString() }, e);
                            }
                            setElementAttribute(
                                                element,
                    ...
                    if (pageEncodingSpecified == false) {
                        ...
                        if (jspConfiguration.getPageEncoding() != null) {
                            if (jspConfiguration.getPageEncoding().equalsIgnoreCase(element.getAttribute("pageEncoding")) == false) { //PI37485
                                throw new JspCoreException("jsp.error.encoding.mismatch.config.pageencoding", new Object[] { jspConfiguration.getPageEncoding(),
                                                                                                                             element.getAttribute("pageEncoding") });
                            }
                        } else {
    ...
    protected void processJspComment() throws IOException, JspCoreException {
        ...
        while (endFound == false) {
            ...
            switch (character) {
                case -1: {
                    throw new JspCoreException("jsp.error.end.of.file.reached", new Object[] { "jspComment " + jspCommentText.toString(),
                                                                                               "Line: " + jspSyntaxLineNum + " Col: " + jspSyntaxColNum });
                }
    ...
    protected void processScriptingElement(int type) throws IOException, JspCoreException {
        ...
        while (endFound == false) {
            ...
            switch (character) {
                case -1: {
                    throw new JspCoreException("jsp.error.end.of.file.reached", new Object[] { "scripting element " + value.toString(),
                                                                                               "Line: " + jspSyntaxLineNum + " Col: " + jspSyntaxColNum });
                }
    ...
    private void insertInclude(String includePath) throws JspCoreException {
        ...
        Jsp2Dom jsp2Dom = new Jsp2Dom(includePathInputSource, context, directoryStack, includeConfiguration, jspOptions, //396002
                        dependencyStack, dependencyList, cdataJspIdMap, mergedTagLibMap, false);
