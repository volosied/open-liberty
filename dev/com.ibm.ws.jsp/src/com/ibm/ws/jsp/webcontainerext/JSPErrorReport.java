...
public class JSPErrorReport extends ServletErrorReport {
    ...
    public String getDebugMessageAsHTML() {
        ...
        returnMessage.append("<TR VALIGN=\"BOTTOM\"><TD BGCOLOR=\"#C2B0D6\" ><B><FONT FACE=\"Verdana, Helvitica, sans-serif\"  COLOR=\"black\" SIZE=\"4PT\">"
                             + JspCoreException.getMsg("JSPG0230") + "&nbsp;&nbsp;&nbsp;" + new Integer(this.getErrorCode()).toString() + "</B><BR><BR></TD></TR>");
