...
public class ConnectionProperties {
    ...
    public ConnectionProperties(String dbDriver,
                                String url,
                                String loginUser,
                                String loginPasswd) throws JspCoreException {
    ...
    public ConnectionProperties(String dbDriver,
                                ...
                                String loginUser,
                                String loginPasswd,
                                String queryString) throws JspCoreException {
        setDbDriver(dbDriver);
        setUrl(url);
        setLoginUser(loginUser);
        setLoginPasswd(loginPasswd);
     ...
     */
    public void setDbDriver(String newValue) throws JspCoreException {
        if (newValue == null) {
     ...
     * @param newValue java.lang.String
     */
    public void setUrl(String newValue) throws JspCoreException {
        if (newValue == null) {
