...
public class WebPage {
    ...
    public WebPage(RemoteWebDriver webDriver) {
     ...
     */
    public <V> void waitForCondition(Function<? super RemoteWebDriver, V> isTrue, Duration timeout) {
        synchronized (webDriver) {
            WebDriverWait wait = new WebDriverWait(webDriver, timeout);
            wait.until(isTrue);
        }
    ...
    public <V> void waitForCondition(Function<? super RemoteWebDriver, V> isTrue) {
        synchronized (webDriver) {
    ...
    public void waitForPageToLoad(Duration timeOut) {
        ExpectedCondition<Boolean> expectation = new ExpectedCondition() {
            public Boolean apply(RemoteWebDriver driver) {
                return webDriver.executeScript("return document.readyState").equals("complete");
            }
        };
        synchronized (webDriver) {
            WebDriverWait wait = new WebDriverWait(webDriver, timeOut);
     ...
     */
    public <V> boolean isCondition(Function<? super RemoteWebDriver, V> isTrue) {
        try {
    ...
    // public RemoteWebDriver.TargetLocator switchTo() {
    //     return webDriver.switchTo();
    // }

    // public RemoteWebDriver.Navigation navigate() {
    //     return webDriver.navigate();
    // }

    // public RemoteWebDriver.Options manage() {
