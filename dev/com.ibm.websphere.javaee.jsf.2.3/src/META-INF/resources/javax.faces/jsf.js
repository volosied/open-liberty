...
if (!myfaces._impl.core._EvalHandlers) {
    myfaces._impl.core._EvalHandlers = new (function () {
        var A = this;
        A.globalEval = function (E, F) {
            var D = F ? F.nonce : this._currentScriptNonce();
            ...
            var B = document.head.appendChild(C);
            document.head.removeChild(B);
        };
        A.resolveNonce = function (C) {
            var B = null;
            if (!!(C && C.nonce)) {
                B = C.nonce;
            } else {
                if (!!C && C.getAttribute) {
                    B = C.getAttribute("nonce");
                }
            }
            return !B ? null : B;
        };
        A._currentScriptNonce = function () {
            if (myfaces.config && myfaces.config.cspMeta) {
                return myfaces.config.cspMeta.nonce;
            }
            if (A.resolveNonce(document.currentScript)) {
                return A.resolveNonce(document.currentScript);
            }
            var E = myfaces._impl._util._Lang;
            var C = E.objToArray(document.getElementsByTagName("script")).concat(E.objToArray(document.getElementsByTagName("link")));
            var F = null;
            for (var D = 0; C && D < C.length; D++) {
                ...
                var G = B.getAttribute("src") || "";
                if (G && !G.match(/jsf\.js\?ln\=javax\.faces/gi)) {
                    F = B;
                    break;
                }
            }
            myfaces.config = myfaces.config || {};
            myfaces.config.cspMeta = myfaces.config.cspMeta || { nonce: null };
            if (F) {
                myfaces.config.cspMeta.nonce = A.resolveNonce(F);
            }
            return myfaces.config.cspMeta.nonce;
        };
    })();
...
if (!myfaces._impl.core._Runtime) {
    myfaces._impl.core._Runtime = new (function () {
        ...
        F.globalEval = function (I, J) {
            return myfaces._impl.core._EvalHandlers.globalEval(I, J);
        };
        F.resolveNonce = function (I) {
            return myfaces._impl.core._EvalHandlers.resolveNonce(I);
        };
        F.applyToGlobalNamespace = function (J, L) {
            var N = J.split(/\./);
            if (N.length == 1) {
                window[J] = L;
                return;
            ...
            var M = N[N.length - 1];
            var I = F.fetchNamespace(K.join("."));
            I[M] = L;
        };
        this.fetchNamespace = function (J) {
            if ("undefined" == typeof J || null == J || !F._reservedNMS[J]) {
                return null;
            }
            var I = null;
            try {
                if (!F.browser.isIE) {
                    I = F.globalEval("window." + J);
                }
            } catch (K) {}
            if ("undefined" != typeof I && null != I) {
                return I;
            }
            return F._manuallyResolveNMS(J);
        };
        F._manuallyResolveNMS = function (K) {
            K = K.split(/\./);
            var J = window;
            var I = K.length;
            for (var L = 0; L < I; L++) {
        ...
        this.isString = function (I) {
            return !!arguments.length && I != null && (typeof I == "string" || I instanceof String);
        };
        this.reserveNamespace = function (N, P) {
            if (!F.isString(N)) {
                throw Error("Namespace must be a string with . as delimiter");
            }
            if (F._reservedNMS[N] || null != F.fetchNamespace(N)) {
                return false;
            }
            var J = N.split(/\./);
            var I = window;
            ...
            for (var O = 0; O < J.length; O++) {
                ...
                if (O == J.length - 1 && M != typeof P) {
                    I[L] = P;
                } else {
                    I = I[L];
                }
                F._reservedNMS[K.join(".")] = true;
            }
            return true;
        };
        this.iterateSingletons = function (I) {
            var L = F._registeredSingletons;
            for (var K in L) {
                var J = F.fetchNamespace(K);
                I(J);
            }
        };
        this.iterateClasses = function (I) {
            var K = F._registeredClasses;
            for (var J = 0; J < K.length; J++) {
                I(K[J], J);
            }
        };
        this.exists = function (J, O) {
            if (!J) {
                return false;
            }
            if (J == window && F._reservedNMS[O]) {
                return true;
            }
            if (!O) {
                return true;
        ...
        this.getGlobalConfig = function (J, I) {
            return myfaces["config"] && "undefined" != typeof myfaces.config[J] ? myfaces.config[J] : I;
        };
        this.getLocalOrGlobalConfig = function (K, L, I) {
            var N = !!K;
            var J;
            var M = "myfaces";
            if (N) {
                J = K[M] ? K[M][L] : undefined;
                N = "undefined" != typeof J;
            }
            return !N ? F.getGlobalConfig(L, I) : J;
        };
        ...
        this.getXHRObject = function () {
            ...
            if (!F[K]) {
                var I = F.exists;
                F[K] = I(J, "sendAsBinary") ? 1.5 : 1;
                F[K] = I(J, "upload") && "undefined" != typeof FormData ? 2 : F.XHR_LEVEL;
            }
            return J;
        };
        this.loadScriptEval = function (O, J, N, K, I, L) {
            var M = F.getXHRObject();
            M.open("GET", O, false);
            if (K) {
                M.setRequestHeader("Content-Type", "text/javascript; charset:" + K);
            }
            M.send(null);
            if (M.readyState == 4) {
                if (M.status == 200) {
                    if (!N) {
                        F.globalEval(M.responseText.replace("\n", "\r\n") + "\r\n//# sourceURL=" + O, L);
                    } else {
                        setTimeout(function () {
                            F.globalEval(M.responseText.replace("\n", "\r\n") + "\r\n//# sourceURL=" + O, L);
                        }, 1);
                    ...
                    throw Error(M.responseText);
                }
            } else {
                throw Error("Loading of script " + O + " failed ");
            }
        };
        this.loadScriptByBrowser = function (I, R, J, L, K, O) {
            var N = "head";
            var P = "undefined";
            try {
                var T = document.getElementsByTagName(N)[0];
                if (P == typeof T || null == T) {
                    T = document.createElement(N);
                    var M = document.getElementsByTagName("html");
                    M.appendChild(T);
                }
                var S = document.createElement("script");
                S.type = R || "text/javascript";
                S.src = I;
                if (O && O.nonce) {
                    S.setAttribute("nonce", O.nonce);
                }
                if (L) {
                    S.charset = L;
                }
        ...
        this.loadScript = function (N, K, M, L, J) {
            var I = F.browser;
            if (!I.isFF && !I.isWebkit && !I.isOpera >= 10) {
                F.loadScriptEval(N, K, M, L);
            } else {
                F.loadScriptByBrowser(N, K, M, L, J);
            }
        };
        this.extendClass = function (S, K, J, M) {
            if (!F.isString(S)) {
                throw Error("new class namespace must be of type String");
            }
            var P = S;
            if (F._reservedNMS[S]) {
                return F.fetchNamespace(S);
            }
            var Q = "constructor_";
            var L = "_mfClazz";
            if (!J[Q]) {
                J[Q] =
                    K[L] || (K.prototype && K.prototype[L])
                        ? function () {
            ...
            if ("undefined" != typeof K && null != K) {
                ...
                var N = R.prototype;
                N.constructor = S;
                N._parentCls = K.prototype;
                N._nameSpace = P.replace(/(\._mfClazz)+$/, "");
                N._callSuper = function (W) {
                    var a = arguments.length == 1 ? [] : Array.prototype.slice.call(arguments, 1);
                    var T = "_mfClsDescLvl";
                    var Y = ["_", W, "_mf_r"].join("");
                    this[T] = this[T] || new Array();
                    var Z = this[T];
                    var V = this[T][Y] || this;
                    var U = V._parentCls;
                    var X = null;
                    try {
                        Z[Y] = U;
                        if (!U[W]) {
                            throw Error("Method _callSuper('" + W + "')  called from " + P + " Method does not exist ");
                        }
                        X = U[W].apply(this, a);
                    } finally {
                        Z[Y] = V;
                ...
                N[L] = S;
                F._registeredClasses.push(N);
            }
            F._applyFuncs(S, J, true);
            F._applyFuncs(S, M, false);
            return S;
        };
        this.singletonExtendClass = function (K, J, I, L) {
            F._registeredSingletons[K] = true;
            return F._makeSingleton(F.extendClass, K, J, I, L);
        };
        this._makeSingleton = function (N, L, K, I, M) {
            if (F._reservedNMS[L]) {
                return F._reservedNMS[L];
            }
            var J = N(L + "._mfClazz", K, I, M);
            if (J != null) {
                F.applyToGlobalNamespace(L, new J());
            }
            return (F.fetchNamespace(L)["_mfClazz"] = J);
        };
        var B = function (L, I) {
            var K = null;
            var J = "undefined";
            if (J != typeof I && null != I) {
                K = (J != typeof null) != I["constructor_"] && null != I["constructor_"] ? I["constructor_"] : function () {};
            } else {
                K = function () {};
            }
            if (!F.reserveNamespace(L, K)) {
                return null;
            }
            L = F.fetchNamespace(L);
            return L;
        };
        this._applyFuncs = function (L, I, K) {
            if (I) {
                for (var J in I) {
                    if ("undefined" == typeof J || null == J || J == "_callSuper") {
                        continue;
                    }
                    if (!K) {
                        L[J] = I[J];
        ...
        this.assertType = function (I, J) {
            return F.isString(J) ? I == typeof J : I instanceof J;
        };
        this.addOnLoad = function (J, I) {
            var K = J ? J.onload : null;
            J.onload = !K
                ? I
                : function () {
                      try {
        ...
        this.getLanguage = function (J) {
            var L = { language: "en", variant: "UK" };
            try {
                var K = J || navigator.language || navigator.browserLanguage;
                if (!K || K.length < 2) {
                    return L;
                }
                return { language: K.substr(0, 2), variant: K.length >= 5 ? K.substr(3, 5) : null };
            } catch (I) {
                return L;
            }
        };
        ...
        var F = this;
        F.browser = {};
        myfaces._impl.core._EvalHandlers.browser = F.browser;
        var G = F.browser;
        ...
        G.isKhtml = E.indexOf("Konqueror") >= 0 ? D : 0;
        G.isWebKit = parseFloat(A.split("WebKit/")[1]) || undefined;
        G.isChrome = parseFloat(A.split("Chrome/")[1]) || undefined;
        var C = Math.max(E.indexOf("WebKit"), E.indexOf("Safari"), 0);
        if (C && !G.isChrome) {
            G.isSafari = parseFloat(E.split("Version/")[1]);
            if (!G.isSafari || parseFloat(E.substr(C + 7)) <= 419.3) {
                G.isSafari = 2;
            }
        }
        if (A.indexOf("Gecko") >= 0 && !G.isKhtml && !G.isWebKit) {
            G.isMozilla = G.isMoz = D;
        }
        if (G.isMoz) {
            G.isFF = parseFloat(A.split("Firefox/")[1] || A.split("Minefield/")[1] || A.split("Shiretoko/")[1]) || undefined;
        }
        if (document.all && !G.isOpera && !G.isBlackBerry) {
            G.isIE = parseFloat(E.split("MSIE ")[1]) || undefined;
            G.isIEMobile = parseFloat(A.split("IEMobile")[1]);
            if (G.isIE >= 8 && document.documentMode != 5) {
...
if (!document.querySelectorAll || !window.XMLHttpRequest) {
    (function () {
        ...
        A.getXHRObject = function () {
            if (window.XMLHttpRequest) {
                var C = new XMLHttpRequest();
                if (!A.XHR_LEVEL) {
                    var B = A.exists;
                    A.XHR_LEVEL = B(C, "sendAsBinary") ? 1.5 : 1;
                    A.XHR_LEVEL = B(C, "upload") && "undefined" != typeof FormData ? 2 : A.XHR_LEVEL;
                }
                return C;
            }
            try {
...
_MF_CLS &&
    _MF_CLS(_PFX_I18N + "Messages", Object, {
        ...
        MSG_DEV_MODE: "Note, this message is only sent, because project stage is development and no " + "other error listeners are registered.",
...
_MF_CLS &&
    _MF_CLS(_PFX_I18N + "Messages_de", myfaces._impl.i18n.Messages, {
        ...
        MSG_DEV_MODE: "Sie sehen diese Nachricht, da sie sich gerade im Entwicklungsmodus befinden " + "und sie keine Fehlerbehandlungsfunktionen registriert haben.",
        ...
        ERR_FORM:
            "Das Quellformular konnte nicht gefunden werden. " +
...
_MF_CLS &&
    _MF_CLS(_PFX_I18N + "Messages_nl", myfaces._impl.i18n.Messages, {
        ...
        MSG_DEV_MODE: "Opmerking, dit bericht is enkel gestuurd omdat het project stadium develoment is en er geen " + "andere listeners zijn geconfigureerd.",
...
_MF_CLS &&
    _MF_CLS(_PFX_I18N + "Messages_fr", myfaces._impl.i18n.Messages, {
        ...
        MSG_DEV_MODE: "Note : ce message n'est envoyé que parce que le projet est au stade de développement et " + "qu'aucun autre listener d'erreurs n'est enregistré.",
        ...
        ERR_FORM:
            "Le formulaire source n'a pas pu être déterminé, soit parce que l'élément n'est rattaché à aucun formulaire, soit parce qu'ils y a plusieurs formulaires contenant des éléments avec le même nom ou identifiant. Arrêt du traitement AJAX",
...
_MF_CLS &&
    _MF_CLS(_PFX_I18N + "Messages_es", myfaces._impl.i18n.Messages, {
        ...
        ERR_FORM:
            "El formulario de origen no ha podido ser determinado, debido a que el elemento no forma parte de un formulario o hay diversos formularios con elementos usando el mismo nombre o identificador. Parando el procesamiento de Ajax.",
...
if (_MF_CLS) {
    _MF_CLS &&
        _MF_CLS(_PFX_I18N + "Messages_ru", myfaces._impl.i18n.Messages, {
            MSG_TEST: "ТестовоеСообщение",
            MSG_DEV_MODE: "Это сообщение выдано, потому что 'project stage' было присоено значение 'development', и никаких" + "других error listeners зарегистрировано не было.",
...
if (_MF_CLS) {
    _MF_CLS &&
        _MF_CLS(_PFX_I18N + "Messages_zh_CN", myfaces._impl.i18n.Messages, {
            MSG_TEST: "测试信息",
...
_MF_CLS &&
    _MF_CLS(_PFX_I18N + "Messages_zh_HK", myfaces._impl.i18n.Messages, {
        MSG_TEST: "測試信息",
...
if (_MF_CLS) {
    _MF_CLS &&
        _MF_CLS(_PFX_I18N + "Messages_zh_TW", myfaces._impl.i18n.Messages, {
            MSG_TEST: "測試信息",
            MSG_DEV_MODE: "請注意，此信息只在項目發展階段，及沒有註冊錯誤監聽器而發放。",
            MSG_AFFECTED_CLASS: "受影響類別：",
            MSG_AFFECTED_METHOD: "受影響方法：",
...
_MF_SINGLTN(_PFX_UTIL + "_Lang", Object, {
    ...
    initLocale: function (A) {
        ...
        var D = this._RT.getLanguage(this._RT.getGlobalConfig("locale")),
            C = D ? D.language : "",
            F = D ? [D.language, "_", D.variant || ""].join("") : "",
            E = myfaces._impl.i18n,
            B = E["Messages_" + F] || E["Messages_" + C] || E["Messages"];
    ...
    _assertStr: function (A, B, C) {
        if (!this.isString(A)) {
            throw this.makeException(new Error(), null, null, this._nameSpace, arguments.caller.toString(), this.getMessage("ERR_PARAM_STR", null, "myfaces._impl._util._Lang." + B, C));
        }
    },
    trim: function (C) {
    ...
    mixMaps: function (E, G, D, C, B) {
        ...
        for (var F in G) {
            ...
            if (!D) {
                E[F] = A != typeof E[F] ? E[F] : G[F];
            } else {
                E[F] = A != typeof G[F] ? G[F] : E[F];
            }
        }
        return E;
    },
    ...
    arrForEach: function (A, D, B, C) {
        ...
        var E = C || A;
        A = this.objToArray(A);
        F ? A.slice(F).forEach(D, E) : A.forEach(D, E);
    },
    arrFilter: function (A, D, B, C) {
        if (!A || !A.length) {
            return [];
        }
        var F = B || 0;
        var E = C || A;
        A = this.objToArray(A);
        return F ? A.slice(F).filter(D, E) : A.filter(D, E);
    },
    ...
    keyValToStr: function (C, E, A) {
        var B = [],
            D = this.hitch(B, B.push);
        D(C);
        D(E);
        A = A || "\n";
        D(A);
    ...
    fetchXMLErrorMessage: function (H, C) {
        var I = this;
        var D = function (P) {
            if (!P || !P.childNodes) {
                return false;
            ...
            for (var O = 0; O < P.childNodes.length; O++) {
                var N = P.childNodes[O];
                if (N.tagName && N.tagName == "parsererror") {
                    var M = I.serializeXML(N.childNodes[0]);
                    var K = M.split("\n");
                    K = K[K.length - 1];
                    var J = K.match(/[^0-9]*([0-9]+)[^0-9]*([0-9]+)[^0-9]*/);
                    var L = { errorMessage: M, sourceText: I.serializeXML(N.childNodes[1].childNodes[0]) };
                    if (J) {
                        L.line = Math.max(0, parseInt(J[1]) - 1);
                        L.linePos = Math.max(0, parseInt(J[2]) - 1);
                    }
                    return L;
                }
            }
        ...
        var F = null;
        if (!C) {
            F = this.trim(H || "").length > 0 ? { errorMessage: "Illegal response", sourceText: "" } : { errorMessage: "Empty Response", sourceText: "" };
        } else {
            if (this.exists(C, "parseError.errorCode") && C.parseError.errorCode != 0) {
                F = { errorMessage: C.parseError.reason, line: Math.max(0, parseInt(C.parseError.line) - 1), linePos: Math.max(0, parseInt(C.parseError.linepos) - 1), sourceText: C.parseError.srcText };
            } else {
                F = D(C);
            }
        }
        if (F && "undefined" != typeof F.line) {
            var A = F.sourceText || "";
            A = A.split("\n");
            if (A.length - 1 < F.line) {
                return F;
            }
            A = A[F.line];
            var G = [];
    ...
    createFormDataDecorator: function (C) {
        var D = null;
        var A = null;
        var B = this;
        if (!this.FormDataDecoratorArray) {
            this.FormDataDecoratorArray = function (E) {
                this._valBuf = E;
                this._idx = {};
                var F = this;
                B.arrForEach(E, function (H) {
                    var G = H[0];
                    F._idx[decodeURIComponent(G)] = true;
                });
            };
            D = this.FormDataDecoratorArray;
            D.prototype.append = function (E, F) {
                this._valBuf.push([encodeURIComponent(E), encodeURIComponent(F)].join("="));
                this._idx[E] = true;
            };
            D.prototype.hasKey = function (E) {
                return !!this._idx[E];
            };
            D.prototype.makeFinal = function () {
                return this._valBuf.join("&");
            };
        }
        if (!this.FormDataDecoratorString) {
            this.FormDataDecoratorString = function (E) {
                this._preprocessedData = E;
                this._valBuf = [];
                this._idx = {};
                var F = this;
                var G = E.split(/\&/gi);
                B.arrForEach(G, function (I) {
                    var H = B.trim(I.split(/\=/gi)[0]);
                    F._idx[decodeURIComponent(H)] = true;
                });
            };
            D = this.FormDataDecoratorString;
            D.prototype.append = function (E, F) {
                this._valBuf.push([encodeURIComponent(E), encodeURIComponent(F)].join("="));
                this._idx[E] = true;
            };
        ...
        if (!this.FormDataDecoratorOther) {
            this.FormDataDecoratorOther = function (E) {
                this._valBuf = E || [];
                this._idx = {};
            };
            D = this.FormDataDecoratorOther;
            D.prototype.append = function (E, F) {
                this._valBuf.push([encodeURIComponent(E), encodeURIComponent(F)]);
                this._idx[E] = true;
            };
            D.prototype.hasKey = function (E) {
                return !!(this._idx[E] || this._valBuf.has(E));
            };
            D.prototype.makeFinal = function () {
                return this._valBuf;
            };
        ...
        if (C instanceof Array) {
            A = new this.FormDataDecoratorArray(C);
        } else {
            if (this.isString(C)) {
                A = new this.FormDataDecoratorString(C);
            } else {
                A = new this.FormDataDecoratorOther(C);
            }
        }
        return A;
    },
    attr: function (H, C, G) {
        ...
        try {
            ...
            throw this.makeException(new Error(), null, null, this._nameSpace, "contains", "property " + C + " not found");
        } finally {
            A = null;
            B = null;
        }
    },
    makeException: function (C, F, B, D, A, E) {
        C.name = B || "clientError";
        C.title = F || "";
        C.message = E || "";
        C._mfInternal = {};
        C._mfInternal.name = B || "clientError";
        C._mfInternal.title = F || "clientError";
        C._mfInternal.caller = D || this._nameSpace;
        C._mfInternal.callFunc = A || "" + arguments.caller.toString();
        return C;
    },
});
...
(function () {
    ...
    A._MF_OBJECT = myfaces._impl.core.Object;
})();
...
(function () {
    var A = window || document;
    A._MF_OBJECT = myfaces._impl.core.ObjectQuirks;
})();
...
_MF_CLS(_PFX_UTIL + "_ListenerQueue", myfaces._impl._util._Queue, {
    _assertListener: function (A) {
        if ("function" != typeof A) {
            ...
            throw this._Lang.makeException(new Error(), null, null, this._nameSpace, arguments.caller.toString(), B);
        }
    },
    enqueue: function (A) {
...
_MF_SINGLTN(_PFX_UTIL + "_Dom", Object, {
    TABLE_ELEMS: { thead: 1, tbody: 1, tr: 1, th: 1, td: 1, tfoot: 1 },
    _Lang: myfaces._impl._util._Lang,
    _RT: myfaces._impl.core._Runtime,
    _dummyPlaceHolder: null,
    constructor_: function () {},
    runScripts: function (L, A) {
        var G = this;
        var I = [];
        var H = this._RT;
        var C = function (P) {
        ...
        var E = this._Lang,
            B = function (Q) {
                var M = Q.tagName;
                var O = Q.type || "";
                if (M && E.equalsIgnoreCase(M, "script") && (O === "" || E.equalsIgnoreCase(O, "text/javascript") || E.equalsIgnoreCase(O, "javascript") || E.equalsIgnoreCase(O, "text/ecmascript") || E.equalsIgnoreCase(O, "ecmascript"))) {
                    var N = H.resolveNonce(Q);
                    var R = Q.getAttribute("src");
                    if ("undefined" != typeof R && null != R && R.length > 0) {
                        if ((R.indexOf("ln=scripts") == -1 && R.indexOf("ln=javax.faces") == -1) || (R.indexOf("/jsf.js") == -1 && R.indexOf("/jsf-uncompressed.js") == -1 && R.indexOf("/jsf-development.js") == -1)) {
                            I = C(I);
                            H.loadScriptEval(R, Q.getAttribute("type"), false, "UTF-8", false, N ? { nonce: N } : null);
                        }
                    } else {
                        var S = !A ? Q.text : E.serializeChilds(Q);
                        var P = true;
                        while (P) {
                            P = false;
                            if (S.substring(0, 1) == " ") {
                            ...
                            if (S.substring(0, 11) == "//<![CDATA[") {
                                S = S.substring(11);
                                P = true;
                            }
                        }
                        I.push(N ? { cspMeta: { nonce: N }, text: S } : { text: S });
                    }
                }
            };
        try {
            var F = this.findByTagName(L, "script", true);
            if (F == null) {
                return;
            }
            ...
            if (jsf.getProjectStage() === "Development") {
                var K = myfaces._impl.core._Runtime.getGlobalConfig("defaultErrorOutput", alert);
                K("Error in evaluated javascript:" + (J.message || J.description || J));
            }
        } finally {
            B = null;
        }
    ...
    nodeIdOrName: function (B) {
        if (B) {
            ...
            if ((B.id == null || B.id == "") && B.name) {
                A = B.name;
                if (document.getElementsByName(A).length > 1) {
                    return null;
                }
            }
            return A;
    ...
    deleteItem: function (B) {
        var A = this.byId(B);
        if (!A) {
            throw this._Lang.makeException(new Error(), null, null, this._nameSpace, "deleteItem", "_Dom.deleteItem  Unknown Html-Component-ID: " + B);
        }
    ...
    insertBefore: function (F, C) {
        ...
        var G = this._buildEvalNodes(F, C),
            B = F,
            A = F.parentNode,
            D = [];
    ...
    propertyToAttribute: function (A) {
        if (A === "className") {
            return "class";
        } else {
            if (A === "xmllang") {
    ...
    isFunctionNative: function (A) {
        return /^\s*function[^{]+{\s*\[native code\]\s*}\s*$/.test(String(A));
    },
    detectAttributes: function (A) {
        if (A.hasAttribute && this.isFunctionNative(A.hasAttribute)) {
            return function (B) {
    ...
    cloneAttributes: function (A, S) {
        var X = ["className", "title", "lang", "xmllang", "href", "rel", "src"];
        var Y = ["name", "value", "size", "maxLength", "src", "alt", "useMap", "tabIndex", "accessKey", "accept", "type"];
        var V = ["checked", "disabled", "readOnly"];
        var j = [
            "onclick",
            "ondblclick",
            "onmousedown",
        ...
        var L = this.detectAttributes(S);
        var T = this.detectAttributes(A);
        var g = A.nodeName.toLowerCase() === "input";
        var B = g ? X.concat(Y) : X;
        var R = !S.ownerDocument.contentType || S.ownerDocument.contentType == "text/xml";
        for (var U = 0, H = B.length; U < H; U++) {
            var i = B[U];
            var e = this.propertyToAttribute(i);
            if (L(e)) {
                if (e == "class") {
                    if (this._RT.browser.isIE && S.getAttribute(i) === S[i]) {
                        e = i;
                    }
                }
                var a = R ? S.getAttribute(e) : S[i];
                var G = A[i];
                if (G != a) {
                    A[i] = a;
                }
        ...
        if (!this._RT.browser.isIE && S.dir != A.dir) {
            if (L("dir")) {
                A.dir = S.dir;
            } else {
                if (T("dir")) {
        ...
        var M = S.hasAttributes() ? S.attributes : [];
        var d = this._Lang.arrFilter(M, function (k) {
            return k.name && k.name.indexOf("data-") == 0;
        });
        this._Lang.arrForEach(d, function (k) {
            if (A.setAttribute) {
                var l = S.getAttribute(k) || S[k];
                A.setAttribute(k, l);
            } else {
                A[k] = l;
            }
        });
        var Q = this._RT.resolveNonce(S);
        if (!!Q) {
            A["nonce"] = Q;
        }
    },
    ...
    outerHTML: function (E, B, A) {
        this._assertStdParams(E, B, "outerHTML");
        if (E.nodeName.toLowerCase() === "input") {
            var G = this._buildEvalNodes(E, B)[0];
            this.cloneAttributes(E, G);
            return E;
        } else {
            B = this._Lang.trim(B);
            if (B !== "") {
                ...
                var H = null;
                var F = 0;
                if (A && "undefined" != typeof document.activeElement) {
                    H = document.activeElement ? document.activeElement.id : null;
                    F = this.getCaretPosition(document.activeElement);
                }
                if (this.isDomCompliant()) {
                    C = this._outerHTMLCompliant(E, B);
                } else {
                    C = this._outerHTMLNonCompliant(E, B);
                }
                if (H) {
                    var D = this.byId(H);
                    if (D && D.nodeName.toLowerCase() === "input") {
                        if ("undefined" != typeof D.focus) {
                            D.focus();
                        }
                    }
                    if (D && F) {
                        this.setCaretPosition(D, F);
                    }
                }
                this._eval(C);
                return C;
            }
            this._removeNode(E, false);
            return null;
        }
    },
    detach: function (A) {
    ...
    _buildTableNodes: function (F, B) {
        var A = (F.nodeName || F.tagName).toLowerCase();
        var C = A;
        var G = 0;
        while (C != "table") {
            F = F.parentNode;
            C = (F.nodeName || F.tagName).toLowerCase();
            G++;
        }
        var E = this.getDummyPlaceHolder();
        if (A == "td") {
            E.innerHTML = "<table><tbody><tr>" + B + "</tr></tbody></table>";
        } else {
            E.innerHTML = "<table>" + B + "</table>";
        }
        for (var D = 0; D < G; D++) {
            E = E.childNodes[0];
        }
        return this.detach(E.childNodes);
    },
    ...
    _buildEvalNodes: function (C, A) {
        var D = null;
        if (C && this._isTableElement(C)) {
            D = this._buildTableNodes(C, A);
        } else {
            var B = !this._RT.browser.isIE || this._RT.browser.isIE > 8;
            D = this.isDomCompliant() && B ? this._buildNodesCompliant(A) : this._buildNodesNonCompliant(A);
        }
        return D;
    },
    _assertStdParams: function (F, B, C, H) {
        ...
        var D = this._Lang,
            A = "ERR_MUST_BE_PROVIDED1",
            E = "myfaces._impl._util._Dom.",
            G = H || ["item", "markup"];
        if (!F || !B) {
            D.makeException(new Error(), null, null, E, "" + C, D.getMessage(A, null, E + "." + C, !F ? G[0] : G[1]));
        }
    },
    _eval: function (C) {
    ...
    _iteratorSearchAll: function (D, B, E) {
        ...
        var A = NodeFilter.FILTER_ACCEPT,
            F = NodeFilter.FILTER_SKIP,
    ...
    setAttribute: function (B, A, C) {
        ...
        if (A === "disabled") {
            B.disabled = C === "disabled" || C === "true";
        } else {
            if (A === "checked") {
                B.checked = C === "checked" || C === "on" || C === "true";
            } else {
                if (A == "readonly") {
                    B.readOnly = C === "readonly" || C === "true";
                } else {
                    B.setAttribute(A, C);
                }
            }
    ...
    html5FormDetection: function (A) {
        ...
        return B ? this.byId(B) : null;
    },
    getParent: function (D, C) {
        if (!D) {
            throw this._Lang.makeException(new Error(), null, null, this._nameSpace, "getParent", this._Lang.getMessage("ERR_MUST_BE_PROVIDED1", null, "_Dom.getParent", "item {DomNode}"));
        }
        var B = this._Lang;
        var A = function (E) {
    ...
    isMultipartCandidate: function (B) {
        if (this._Lang.isString(B)) {
            B = this._Lang.strToArray(B, /\s+/);
        }
        for (var F = 0, A = B.length; F < A; F++) {
            var E = this.byId(B[F]);
            var C = this.findByTagName(E, "input", true);
            for (var G = 0, D = C.length; G < D; G++) {
                if (this.getAttribute(C[G], "type") == "file") {
                    return true;
                }
            }
        }
    ...
    getNamedElementFromForm: function (B, A) {
        return B[A];
    },
    fromMarkup: function (A) {
        var D = document.implementation.createHTMLDocument("");
        var B = A.toLowerCase();
        if (B.indexOf("<!doctype") != -1 || B.indexOf("<html") != -1 || B.indexOf("<head") != -1 || B.indexOf("<body") != -1) {
            D.documentElement.innerHTML = A;
    ...
    appendToHead: function (J) {
            ...
            switch ((S.tagName || "").toLowerCase()) {
                case "script":
                    ...
                    for (var P = 0; P < M.length; P++) {
                        if (T && B.match(M[P].getAttribute("src"), T)) {
                            return false;
                        } else {
                            if (!T && B.match(M[P].innerText, R)) {
                                return false;
                            }
                        }
                    }
                ...
                case "style":
                    var R = S.innerText;
                    var Q = document.head.getElementsByTagName("style");
                    for (var P = 0; P < Q.length; P++) {
                        if (R && B.match(Q[P].innerText, R)) {
                            return false;
                        }
                    }
                    break;
                case "link":
                    ...
                    for (var P = 0; P < N.length; P++) {
                        if (O && B.match(N[P].getAttribute("href"), O)) {
                            return false;
                        } else {
                            if (!O && B.match(N[P].innerText, R)) {
                                return false;
                            }
                        }
                    }
        ...
        var L = function (P) {
            ...
            var O = F.resolveNonce(P);
            if (N === "script") {
                var M = document.createElement("script");
                M.textContent = P.textContent;
                C.cloneAttributes(M, P);
                P = M;
            } else {
                if (N === "link") {
        ...
        var A = [];
        if (this._Lang.isString(J)) {
            var K = document.getElementsByTagName("head")[0].lastChild;
            A = this._buildEvalNodes(null, J);
        } else {
            A = J.childNodes;
        }
        var E = this._Lang.arrFilter(
            A,
            function (M) {
                return (M.tagName || "").toLowerCase() == "script";
            },
            0,
            this
        );
        var H = this._Lang.arrFilter(
            A,
            function (M) {
                return (M.tagName || "").toLowerCase() != "script";
            },
        ...
        var I = this._Lang.arrFilter(H, D, 0, this);
        var G = this._Lang.arrFilter(E, D, 0, this);
        this._Lang.arrForEach(I, L);
        this._Lang.arrForEach(G, L);
    },
});
if (_MF_SINGLTN) {
    _MF_SINGLTN(_PFX_UTIL + "_DomExperimental", myfaces._impl._util._Dom, {
        constructor_: function () {
            this._callSuper("constructor_");
...
if (_MF_SINGLTN) {
    _MF_SINGLTN(_PFX_UTIL + "DomQuirks", myfaces._impl._util._Dom, {
            ...
            for (var C = E.childNodes.length - 1; C >= 0; C -= 1) {
                ...
                try {
                    ...
                    if (!H[G]) {
                        ...
                        if (A.isIE && A.isIE < 8 && "undefined" != typeof B.outerHTML) {
                            B.outerHTML = "";
                        } else {
                            E.removeChild(B);
                        }
        ...
        setAttribute: function (B, A, D) {
            this._assertStdParams(B, A, "setAttribute");
            var C = this._RT.browser;
            if (!C.isIE || (C.isIE > 7 && this.isDomCompliant())) {
                this._callSuper("setAttribute", B, A, D);
                return;
            }
            A = A.toLowerCase();
            if (A === "class") {
                ...
                if (A === "name") {
                    ...
                    if (A === "for") {
                        if (!C.isIEMobile || C.isIEMobile >= 7) {
                            B.setAttribute("htmlFor", D);
                        } else {
                            B.htmlFor = D;
                        }
                    } else {
        ...
        getNamedElementFromForm: function (F, A) {
            var C = this._RT.browser;
            if (C.isIE && C.isIE < 8) {
                if (!F.elements) {
                    return null;
                }
                for (var E = 0, B = F.elements.length; E < B; E++) {
                    var D = F.elements[E];
                    if (D.name == A) {
                        return D;
                    }
        ...
        detectAttributes: function (D) {
            if (D.hasAttribute && this.isFunctionNative(D.hasAttribute)) {
                return function (E) {
                    return D.hasAttribute(E);
                };
            } else {
                try {
                    D.getAttribute;
        ...
        html5FormDetection: function () {
            return null;
        },
    });
}
_MF_CLS(_PFX_UTIL + "_HtmlStripper", _MF_OBJECT, {
    parse: function (O, M) {
        var N = "html",
            E = -1,
            B = -1,
...
_MF_SINGLTN(_PFX_XHR + "_AjaxUtils", _MF_OBJECT, {
    ...
    encodeSubmittableFields: function (E, A, C) {
        if (!A) {
            throw "NO_PARITEM";
        }
        if (C) {
    ...
    appendIssuingItem: function (D, G) {
        var B = D.id || D.name;
        var C = ((D && D.type) || "").toLowerCase();
        if (G.hasKey(B)) {
            return;
        }
        ...
        if (A && !D.checked) {
            ...
            if (A) {
                var E = "undefined" == typeof D.value || null == D.value ? true : D.value;
                G.append(B, E);
            } else {
                if (!("undefined" == typeof D.value || null == D.value)) {
                    var F = D.value;
                    G.append(B, F);
                }
            }
    ...
    _$ncRemap: function (D, A) {
        var B = D[this.NAMED_VIEWROOT];
        var C = D[this.NAMING_CONTAINER_ID];
        if (!B || !C) {
            return A;
        }
        if (A.indexOf(C) == 0) {
    ...
    _assignNamingContainerData: function (D, C, A) {
        const B = this._resolveViewRootId(C, A);
        if (!!B) {
            D[this.NAMED_VIEWROOT] = true;
            D[this.NAMING_CONTAINER_ID] = B;
        }
    },
    _resolveViewRootId: function (C, A) {
        C = this._Dom.byId(C);
        var D = this;
        var B = this._Dom.findAll(
            C,
            function (F) {
                var E = null;
                if (F.getAttribute && F.getAttribute("name")){
                    E = F.getAttribute("name");
                }
                if (!E || E.indexOf(D.P_VIEWSTATE)) {
                    return false;
                }
                return F;
            },
        ...
        return B[0].name.split(A, 2)[0];
    },
    _resoveConfigNamingContainerMapper: function (B, A) {
        var E = !!B[this.NAMED_VIEWROOT];
        if (!E) {
            return;
        }
        var C = B[this.NAMING_CONTAINER_ID];
        var D = C + this.getSeparatorChar();
        return function (H) {
            var F = {};
            for (var G in H) {
...
_MF_CLS(_PFX_XHR + "engine.Xhr1", myfaces._impl.xhrCore.engine.BaseRequest, {
    ...
    onreadystatechange: function (B) {
        var C = B || {};
        var F = this._xhrObject;
        var E = this._XHRConst;
        try {
            this.readyState = F.readyState;
            this.status = "" + F.status;
        } catch (D) {}
        switch (this.readyState) {
            case E.READY_STATE_OPENED:
                this._addProgressAttributes(C, 10, 100);
                this.onprogress(C);
                break;
            case E.READY_STATE_HEADERS_RECEIVED:
                this._addProgressAttributes(C, 25, 100);
                this.onprogress(C);
                break;
            case E.READY_STATE_LOADING:
            ...
            case E.READY_STATE_DONE:
                ...
                try {
                    var A = F.status;
                    if (A >= E.STATUS_OK_MINOR && A < E.STATUS_OK_MAJOR) {
                        this.onload(C);
                    } else {
                        C.type = "error";
                        this.onerror(C);
    ...
    _transferRequestValues: function () {
        var A = "undefined";
        var B = this._xhrObject;
        this.responseText = A != typeof B.responseText ? B.responseText : null;
        this.responseXML = A != typeof B.responseXML ? B.responseXML : null;
        this.status = A != typeof B.status ? B.status : null;
        this.statusText = A != typeof B.statusText ? B.statusText : null;
        this.response = A != typeof B.response ? B.response : null;
    },
    _startTimeout: function () {
        ...
        var B = this._xhrObject;
        try {
            if ("undefined" != typeof B.timeout) {
                B.timeout = this.timeout;
                B.ontimeout = this.ontimeout;
                return;
            }
        } catch (A) {}
        this._timeoutTimer = setTimeout(
            this._Lang.hitch(this, function () {
                if (B.readyState != this._XHRConst.READY_STATE_DONE) {
...
_MF_CLS(_PFX_XHR + "engine.IFrame", myfaces._impl.xhrCore.engine.BaseRequest, {
    ...
    send: function (D) {
        var B = {};
        this._addProgressAttributes(B, 20, 100);
        this.onloadstart(B);
        this.onprogress(B);
        var F = D.form,
            C = F.target,
...
_MF_CLS(_PFX_XHR + "_AjaxRequest", _MF_OBJECT, {
    ...
    constructor_: function (A) {
        try {
            ...
            this._stdErrorHandler(this._xhr, this._context, C);
        }
    },
    send: function () {
        var C = this._Lang;
        var D = this._RT;
        try {
            var G = C.hitch(this, function (J) {
                return C.hitch(this, this[J]);
            });
            this._xhr = C.mixMaps(this._getTransport(), { onprogress: G("onprogress"), ontimeout: G("ontimeout"), onloadend: G("ondone"), onload: G("onsuccess"), onerror: G("onerror") }, true);
            var I = this._xhr,
                A = this._sourceForm,
                F = typeof A.elements[this.ENCODED_URL] == "undefined" ? A.action : A.elements[this.ENCODED_URL].value,
                B = this.getFormData();
            for (var H in this._passThrough) {
                if (!this._passThrough.hasOwnProperty(H)) {
                    continue;
                }
                B.append(H, this._passThrough[H]);
            }
            I.open(this._ajaxType, F + (this._ajaxType == "GET" ? "?" + this._formDataToURI(B) : ""), true);
            I.timeout = this._timeout || 0;
            this._applyContentType(I);
            I.setRequestHeader(this._HEAD_FACES_REQ, this._VAL_AJAX);
            if (this._RT.browser.isWebKit) {
                I.setRequestHeader("Accept", "text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8");
            }
    ...
    _applyContentType: function (A) {
        var B = this._contentType + "; charset=utf-8";
        A.setRequestHeader(this._CONTENT_TYPE, B);
    },
    ondone: function () {
        this._requestDone();
    },
    onsuccess: function () {
        ...
        try {
            ...
            A._mfInternal = A._mfInternal || {};
            jsf.ajax.response(C.getXHRObject ? C.getXHRObject() : C, A);
        } catch (B) {
            this._stdErrorHandler(this._xhr, this._context, B);
        }
    },
    onerror: function () {
        var A = this._context;
        ...
        try {
            ...
            var D = "undefined" != I.status && null != I.status ? I.status : H;
            var B = "undefined" != I.statusText && null != I.statusText ? I.statusText : H;
            E = C.getMessage("ERR_REQU_FAILED", null, D, B);
        } catch (F) {
            E = C.getMessage("ERR_REQ_FAILED_UNKNOWN", null);
        } finally {
            var G = this.attr("impl");
            G.sendError(I, A, G.HTTPERROR, G.HTTPERROR, E, "", "myfaces._impl.xhrCore._AjaxRequest", "onerror");
        }
    },
    onprogress: function () {},
    ontimeout: function () {
    ...
    getFormData: function () {
        var C = this._AJAXUTIL,
            A = this._context.myfaces,
            B = null;
    ...
    _isBehaviorEvent: function () {
        var B = this._passThrough[this.attr("impl").P_BEHAVIOR_EVENT] || null;
        var A = !!B && B != "click";
        return A;
    },
    _stdErrorHandler: function (C, B, A) {
        var D = this._xhrQueue;
        try {
            this.attr("impl").stdErrorHandler(C, B, A);
        } finally {
            if (D) {
                D.cleanup();
            }
...
_MF_CLS(_PFX_XHR + "_AjaxRequestQuirks", myfaces._impl.xhrCore._AjaxRequest, {
    constructor_: function (A) {
        this._callSuper("constructor_", A);
    },
    send: function () {
        ...
        var F = this._Dom;
        try {
            var H = C.hitch(this, function (K) {
                return C.hitch(this, this[K]);
            });
            this._xhr = C.mixMaps(this._getTransport(), { onprogress: H("onprogress"), ontimeout: H("ontimeout"), onload: H("onsuccess"), onerror: H("onerror") }, true);
            this._applyClientWindowId();
            var J = this._xhr,
                A = this._sourceForm,
                G = typeof A.elements[this.ENCODED_URL] == "undefined" ? A.action : A.elements[this.ENCODED_URL].value,
                B = this.getFormData();
            for (var I in this._passThrough) {
                if (!this._passThrough.hasOwnProperty(I)) {
                    continue;
                }
                B.append(I, this._passThrough[I]);
            }
            J.open(this._ajaxType, G + (this._ajaxType == "GET" ? "?" + this._formDataToURI(B) : ""), true);
            J.timeout = this._timeout || 0;
            this._applyContentType(J);
            J.setRequestHeader(this._HEAD_FACES_REQ, this._VAL_AJAX);
            if (this._RT.browser.isWebKit) {
                J.setRequestHeader("Accept", "text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8");
            }
            this._sendEvent("BEGIN");
            if (B && B.makeFinal) {
                B = B.makeFinal();
            }
            J.send(this._ajaxType != "GET" ? B : null);
        } catch (E) {
            E = E._mfInternal ? E : this._Lang.makeException(new Error(), "sendError", "sendError", this._nameSpace, "send", E.message);
            this._stdErrorHandler(this._xhr, this._context, E);
        } finally {
    ...
    _applyClientWindowId: function () {
        var A = this._Dom.getNamedElementFromForm(this._sourceForm, "javax.faces.ClientWindow");
        if ("undefined" != typeof this._context._mfInternal._clientWindow) {
            this._context._mfInternal._clientWindowOld = A.value;
            A.value = this._context._mfInternal._clientWindow;
        } else {
            if (A) {
                this._context._mfInternal._clientWindowDisabled = !!A.disabled;
                A.disabled = true;
            }
        }
    },
    _restoreClientWindowId: function () {
        ...
        if ("undefined" != typeof this._context._mfInternal._clientWindowDisabled) {
            A.disabled = this._context._mfInternal._clientWindowDisabled;
        }
    },
    onsuccess: function () {
    ...
    getFormData: function () {
        var A = this._Lang.createFormDataDecorator(jsf.getViewState(this._sourceForm));
        if (this._source && !this._isBehaviorEvent()) {
...
_MF_CLS(_PFX_XHR + "_FormDataRequest", myfaces._impl.xhrCore._AjaxRequest, {
    ...
    getFormData: function () {
        ...
        if (!this._partialIdsArray || !this._partialIdsArray.length) {
            B = new FormData();
            C.encodeSubmittableFields(B, this._sourceForm);
            if (this._source && !this._isBehaviorEvent()) {
                C.appendIssuingItem(this._source, B);
            }
        } else {
...
_MF_CLS(_PFX_XHR + "_IFrameRequest", myfaces._impl.xhrCore._AjaxRequest, {
    ...
    getFormData: function () {
        var D = new myfaces._impl.xhrCore.engine.FormData(this._sourceForm);
        D.append(this.MF_PART_IFRAME, "true");
        D.append(this.MF_PART_FACES_REQUEST, "partial/ajax");
        var F = decodeURIComponent(jsf.getViewState(this._sourceForm));
        F = F.split("&");
        for (var E = 0, B = F.length; E < B; E++) {
            var G = F[E];
            var A = G.split("=");
            var C = A[0];
            if (!this._Dom.getNamedElementFromForm(this._sourceForm, C)) {
                D.append(C, A[1]);
            }
        }
        return D;
...
_MF_SINGLTN(_PFX_XHR + "_AjaxResponse", _MF_OBJECT, {
    ...
    processResponse: function (G, C) {
        C._mfInternal = C._mfInternal || {};
        var B = C._mfInternal;
        B._updateElems = [];
        B._updateForms = [];
        B.appliedViewState = null;
        B.appliedClientWindow = null;
        B.namingModeId = null;
        try {
            var L = this.attr("impl"),
                E = this._Lang;
            if (!G || !E.exists(G, "responseXML")) {
                throw this.makeException(new Error(), L.EMPTY_RESPONSE, L.EMPTY_RESPONSE, this._nameSpace, "processResponse", "");
            }
            var F = G.responseXML;
            var I = E.fetchXMLErrorMessage(G.responseText || G.response, F);
            if (I) {
                throw this._raiseError(new Error(), I.errorMessage + "\n" + I.sourceText + "\n" + I.visualError + "\n", "processResponse");
            }
            var J = F.childNodes[0];
            if ("undefined" == typeof J || J == null) {
                throw this._raiseError(new Error(), "No child nodes for response", "processResponse");
            } else {
                if (J.tagName != this.RESP_PARTIAL) {
                    J = J.nextSibling;
                    if (!J || J.tagName != this.RESP_PARTIAL) {
                        throw this._raiseError(new Error(), "Partial response not set", "processResponse");
                    }
                }
            }
            B.namingModeId = J.id || "";
            var M = J.childNodes.length;
            for (var H = 0; H < M; H++) {
                var A = J.childNodes[H];
                var D = A.tagName;
                if (D == this.CMD_ERROR) {
                    this.processError(G, C, A);
                } else {
                    if (D == this.CMD_REDIRECT) {
                        this.processRedirect(G, C, A);
                    } else {
                        if (D == this.CMD_CHANGES) {
                            this.processChanges(G, C, A);
                        }
                    }
                }
            }
            if (B.appliedViewState) {
                this.fixViewStates(C);
            }
            if (B.appliedClientWindow) {
                this.fixClientWindows(C);
            }
            L.sendEvent(G, C, L["SUCCESS"]);
        } catch (K) {
            ...
            delete B.appliedClientWindow;
            delete B.namingModeId;
        }
    },
    fixViewStates: function (B) {
        var A = this._Lang;
        var C = B._mfInternal;
        if (null == C.appliedViewState) {
            return;
        }
        this._updateJSFClientArtifacts(B, C.appliedViewState, this.P_VIEWSTATE);
    },
    fixClientWindows: function (B, D) {
        var A = this._Lang;
        var C = B._mfInternal;
        if (null == C.appliedClientWindow) {
            return;
        }
        this._updateJSFClientArtifacts(B, C.appliedClientWindow, this.P_CLIENTWINDOW);
    },
    _applyJSFArtifactValueToForm: function (C, I, N, K) {
        if (!I) {
            return;
        }
        var D = this._Lang;
        var M = this._Dom;
        var H = this._getPrefix(C);
        var B = [];
        var A = I.elements;
        ...
        if (B.length) {
            D.arrForEach(B, function (O) {
                M.setAttribute(O, "value", N);
            });
        } else {
            var F = this._Dom.getDummyPlaceHolder();
            F.innerHTML = ["<input type='hidden'", "id='", this._fetchUniqueId(H, K), "' name='", this._getNamingContainerPrefix(C) + K, "' value='", N, "' />"].join("");
            try {
                I.appendChild(F.childNodes[0]);
            } finally {
                F.innerHTML = "";
            }
        }
    },
    _fetchUniqueId: function (C, A) {
        var B = 1;
        var D = C + A + jsf.separatorchar + B;
        while (this._Dom.byId(D) != null) {
            B++;
            D = C + A + jsf.separatorchar + B;
        }
        return D;
    },
    _updateJSFClientArtifacts: function (B, J, I) {
        var H = this._getPrefix(B);
        var C = B._mfInternal._mfSourceFormId ? this._Dom.byId(B._mfInternal._mfSourceFormId) : null;
        if (C) {
            C = this._Dom.byId(C);
            if (C) {
                this._applyJSFArtifactValueToForm(B, C, J, I);
            }
        }
        var G = this._getViewRoot(B);
        var A = this._Dom.findByTagNames(G, { form: 1 }) || [];
        if (this._RT.getLocalOrGlobalConfig(B, "no_portlet_env", false)) {
            this._Lang.arrForEach(
                A,
                this._Lang.hitch(this, function (K) {
                    this._applyJSFArtifactValueToForm(B, K, J, I);
                })
            );
        } else {
            var F = G.id || "";
            for (var D = 0; D < B._mfInternal._updateForms.length; D++) {
                var E = B._mfInternal._updateForms[D];
                if (E.indexOf(F) != 0) {
                    continue;
                } else {
                    this._applyJSFArtifactValueToForm(B, this._Dom.byId(E), J, I);
                }
            }
        }
    },
    _getViewRoot: function (A) {
        var C = this._getPrefix(A);
        if (C == "") {
    ...
    _getPrefix: function (A) {
        var C = A._mfInternal;
        var B = C.namingModeId;
        if (B != "") {
            B = B + jsf.separatorchar;
        }
        return B;
    },
    _getNamingContainerPrefix: function (A) {
        var C = A._mfInternal;
        var B = myfaces._impl.xhrCore._AjaxUtils._$ncRemap(A._mfInternal, "");
        return B;
    },
    processError: function (E, B, D) {
        var C = D.firstChild.textContent || D.firstChild.text || "",
            A = D.childNodes[1].firstChild.data || "";
        this.attr("impl").sendError(E, B, this.attr("impl").SERVER_ERROR, C, A, "myfaces._impl.xhrCore._AjaxResponse", "processError");
    },
    processRedirect: function (D, B, C) {
        var A = this._Lang;
        var E = C.getAttribute("url");
        if (!E) {
            throw this._raiseError(new Error(), A.getMessage("ERR_RED_URL", null, "_AjaxResponse.processRedirect"), "processRedirect");
        }
        E = A.trim(E);
        if (E == "") {
            return false;
    ...
    processChanges: function (F, C, E) {
        var D = E.childNodes;
        var B = this._Lang;
        for (var A = 0; A < D.length; A++) {
            switch (D[A].tagName) {
                case this.CMD_UPDATE:
                    this.processUpdate(F, C, D[A]);
                    break;
                case this.CMD_EVAL:
                    B.globalEval(D[A].firstChild.data);
                    break;
                case this.CMD_INSERT:
                    this.processInsert(F, C, D[A]);
                    break;
                case this.CMD_DELETE:
                    this.processDelete(F, C, D[A]);
                    break;
                case this.CMD_ATTRIBUTES:
                    this.processAttributes(F, C, D[A]);
                    break;
    ...
    processUpdate: function (E, C, D) {
        var H = C._mfInternal;
        if (D.getAttribute("id").indexOf(this.P_VIEWSTATE) != -1 || D.getAttribute("id").indexOf(this.P_CLIENTWINDOW) != -1) {
            if (D.getAttribute("id").indexOf(this.P_VIEWSTATE) != -1) {
                H.appliedViewState = this._Dom.concatCDATABlocks(D);
            } else {
                if (D.getAttribute("id").indexOf(this.P_CLIENTWINDOW) != -1) {
                    H.appliedClientWindow = D.firstChild.nodeValue;
                }
            }
        } else {
            var B = this._Dom.concatCDATABlocks(D),
                A = null,
                G = this._Lang.hitch(this, this._pushOperationResult);
            switch (D.getAttribute("id")) {
                case this.P_VIEWROOT:
                    B = B.substring(B.indexOf("<html"));
                    var F = this._replaceHead(E, C, B);
                    "undefined" != typeof F && null != F ? this._replaceBody(E, C, B, F) : this._replaceBody(E, C, B);
                    break;
                case this.P_VIEWHEAD:
                    this._replaceHead(E, C, B);
                    break;
                case this.P_VIEWBODY:
                    A = this._replaceBody(E, C, B);
                    if (A) {
                        G(C, A);
                    }
                    break;
                case this.P_RESOURCE:
                    this._addResourceToHead(E, C, B);
                    break;
                default:
                    A = this.replaceHtmlItem(E, C, D.getAttribute("id"), B);
                    if (A) {
                        G(C, A);
                    }
                    break;
    ...
    _pushOperationResult: function (D, B) {
        var G = D._mfInternal;
        var F = this._Lang.hitch(this, function (I) {
            var H = this._Dom.getParent(I, "form");
            if (null != H) {
                G._updateForms.push(H.id || H);
            } else {
                G._updateElems.push(I.id || I);
            }
        });
        var A = this._Lang.hitch(this, function (H) {
            if (H.tagName && this._Lang.equalsIgnoreCase(H.tagName, "form")) {
                if (H.id) {
                    G._updateForms.push(H.id);
                }
            } else {
                var J = this._Dom.findByTagName(H, "form");
                if (J && J.length) {
                    for (var I = 0; I < J.length; I++) {
                        if (J[I].id) {
                            G._updateForms.push(J[I].id);
                        }
                    }
                }
            }
        });
        var E = "undefined" != typeof B.length && "undefined" == typeof B.nodeType;
        if (E && B.length) {
    ...
    _replaceHead: function (H, D, F) {
        var C = this._Lang,
            G = this._Dom;
        var B = G.fromMarkup(F);
        var A = B.getElementsByTagName("head")[0];
        var E = document.head.childNodes;
        G.deleteItems(C.objToArray(E));
        G.appendToHead(A);
        return document.head;
    },
    _addResourceToHead: function (C, A, B) {
        this._Dom.appendToHead(B);
    },
    _replaceBody: function (D, A, M) {
        var F = this._RT,
            J = this._Dom,
            H = document.getElementsByTagName("body")[0],
            L = document.createElement("div");
        L.id = "myfaces_bodyplaceholder";
        var C = J.fromMarkup(M);
        var G = C.getElementsByTagName("body")[0];
        J._removeChildNodes(H);
        H.innerHTML = "";
        H.appendChild(L);
        var E = F.browser;
        if (!E.isIEMobile || E.isIEMobile >= 7) {
            for (var B = 0; B < G.attributes.length; B++) {
                var K = G.attributes[B].value;
                if (K) {
                    J.setAttribute(H, G.attributes[B].name, K);
                }
            }
        }
        var I = this.replaceHtmlItem(D, A, L, G.innerHTML);
        if (I) {
            this._pushOperationResult(A, I);
        }
        return I;
    },
    replaceHtmlItem: function (F, C, G, A) {
        var B = this._Lang,
            E = this._Dom;
        var D = !B.isString(G) ? G : E.byIdOrName(G);
        if (!D) {
            throw this._raiseError(new Error(), B.getMessage("ERR_ITEM_ID_NOTFOUND", null, "_AjaxResponse.replaceHtmlItem", G ? G.toString() : "undefined"), "replaceHtmlItem");
        }
        return E.outerHTML(D, A, this._RT.getLocalOrGlobalConfig(C, "preserveFocus", false));
    },
    processInsert: function (H, C, G) {
        var F = this._Dom,
            B = this._Lang,
            E = this._parseInsertData(H, C, G);
        if (!E) {
            return false;
        }
        var D = F.byIdOrName(E.opId);
        if (!D) {
            throw this._raiseError(new Error(), B.getMessage("ERR_PPR_INSERTBEFID_1", null, "_AjaxResponse.processInsert", E.opId), "processInsert");
        }
        var A = F[E.insertType](D, E.cDataBlock);
        if (A) {
            this._pushOperationResult(C, A);
        }
        return true;
    },
    _parseInsertData: function (J, C, F) {
        var G = this._Lang,
            M = this._Dom,
            H = M.concatCDATABlocks,
            N = "insertBefore",
            D = "insertAfter",
            B = F.getAttribute("id"),
            E = F.getAttribute("before"),
            K = F.getAttribute("after"),
            L = {};
        if (B && E && !K) {
            L.insertType = N;
            L.opId = E;
            ...
            if (B && !E && K) {
                ...
                if (!B) {
                    ...
                    if (I != "before" && I != "after") {
                        throw this._raiseError(new Error(), G.getMessage("ERR_PPR_INSERTBEFID"), "_parseInsertData");
                    }
                    I = I.toLowerCase();
                    ...
                    throw this._raiseError(new Error(), [G.getMessage("ERR_PPR_IDREQ"), "\n ", G.getMessage("ERR_PPR_INSERTBEFID")].join(""), "_parseInsertData");
                }
            }
        }
    ...
    processDelete: function (G, C, F) {
        var B = this._Lang,
            ...
            H = F.getAttribute("id");
        if (!H) {
            throw this._raiseError(new Error(), B.getMessage("ERR_PPR_UNKNOWNCID", null, "_AjaxResponse.processDelete", ""), "processDelete");
        }
        var D = E.byIdOrName(H);
        if (!D) {
            throw this._raiseError(new Error(), B.getMessage("ERR_PPR_UNKNOWNCID", null, "_AjaxResponse.processDelete", H), "processDelete");
        }
    ...
    processAttributes: function (F, A, C) {
        ...
        for (var I = 0; I < K.length; I++) {
            var E = K[I],
                J = E.getAttribute("name"),
                H = E.getAttribute("value");
            if (!J) {
                continue;
            }
            J = D.trim(J);
            ...
            switch (B) {
                case this.P_VIEWROOT:
                    throw this._raiseError(new Error(), D.getMessage("ERR_NO_VIEWROOTATTR", null, "_AjaxResponse.processAttributes"), "processAttributes");
                case this.P_VIEWHEAD:
                    throw this._raiseError(new Error(), D.getMessage("ERR_NO_HEADATTR", null, "_AjaxResponse.processAttributes"), "processAttributes");
                case this.P_VIEWBODY:
    ...
    _raiseError: function (D, H, B, F, A) {
        var E = this.attr("impl");
        var I = F || E.MALFORMEDXML;
        var G = A || E.MALFORMEDXML;
        var C = H || "";
        return this._Lang.makeException(D, I, G, this._nameSpace, B || (arguments.caller ? arguments.caller.toString() : "_raiseError"), C);
    },
});
_MF_SINGLTN(_PFX_XHR + "_AjaxResponseQuirks", myfaces._impl.xhrCore._AjaxResponse, {
    constructor_: function () {
        this._callSuper("constructor_");
        myfaces._impl.xhrCore._AjaxResponse = this;
    },
    _replaceHead: function (F, C, M) {
        var D = this._Lang,
            J = this._Dom,
            H = this._RT,
            G = this._RT.browser.isWebKit,
            K = !G ? D.parseXML(M) : null,
            E = null;
        if (!G && D.isXMLParseError(K)) {
            K = D.parseXML(M.replace(/<!\-\-[\s\n]*<!\-\-/g, "<!--").replace(/\/\/-->[\s\n]*\/\/-->/g, "//-->"));
        }
        if (G || D.isXMLParseError(K)) {
            var B = new (this._RT.getGlobalConfig("updateParser", myfaces._impl._util._HtmlStripper))();
            var L = B.parse(M, "head");
            E = D.parseXML("<head>" + L + "</head>");
            if (D.isXMLParseError(E)) {
                try {
                    E = J.createElement("head");
                    E.innerHTML = L;
                } catch (I) {
                    throw this._raiseError(new Error(), "Error head replacement failed reason:" + I.toString(), "_replaceHead");
                }
            }
            E = E.childNodes[0];
        } else {
        ...
        var A = D.objToArray(document.head.childNodes);
        J.deleteItems(D.objToArray(A));
        J.appendToHead(E);
        return document.head;
    },
    _replaceBody: function (E, B, Q) {
        var I = this._RT,
            M = this._Dom,
            D = this._Lang,
            K = document.getElementsByTagName("body")[0],
            P = document.createElement("div"),
            F = I.browser.isWebKit;
        P.id = "myfaces_bodyplaceholder";
        M._removeChildNodes(K);
        K.innerHTML = "";
        K.appendChild(P);
        var H,
            O = null,
        ...
        if (!F && D.isXMLParseError(O)) {
            O = D.parseXML(Q.replace(/<!\-\-[\s\n]*<!\-\-/g, "<!--").replace(/\/\/-->[\s\n]*\/\/-->/g, "//-->"));
        }
        if (F || D.isXMLParseError(O)) {
            A = new (I.getGlobalConfig("updateParser", myfaces._impl._util._HtmlStripper))();
            H = A.parse(Q, "body");
        } else {
            var J = O.getElementsByTagName("body")[0];
            var G = I.browser;
            if (!G.isIEMobile || G.isIEMobile >= 7) {
                for (var C = 0; C < J.attributes.length; C++) {
                    var N = J.attributes[C].value;
                    if (N) {
                        M.setAttribute(K, J.attributes[C].name, N);
                    }
                }
            }
        }
        A = new (I.getGlobalConfig("updateParser", myfaces._impl._util._HtmlStripper))();
        H = A.parse(Q, "body");
        var L = this.replaceHtmlItem(E, B, P, H);
        if (L) {
            this._pushOperationResult(B, L);
        }
        return L;
    },
});
_MF_SINGLTN(_PFX_XHR + "_Transports", _MF_OBJECT, {
    ...
    _getArguments: function (A, C, B, I) {
        var G = myfaces._impl.core._Runtime,
            E = myfaces._impl._util._Lang,
            F = E.hitch(this, this._applyConfig),
            D = G.getLocalOrGlobalConfig,
            H = { source: A, sourceForm: C, context: B, passThrough: I, xhrQueue: this._q };
...
_MF_SINGLTN(_PFX_XHR + "_ExtTransports", myfaces._impl.xhrCore._Transports, {
    ...
    xhrPost: function (E, D, C, A) {
        C._mfInternal.xhrOp = "xhrPost";
        var B = this._getArguments(E, D, C, A);
        delete B.xhrQueue;
        new (this._getAjaxReqClass(C))(B).send();
    },
    xhrGet: function (E, D, C, A) {
        C._mfInternal.xhrOp = "xhrGet";
        var B = this._getArguments(E, D, C, A);
        B.ajaxType = "GET";
        delete B.xhrQueue;
        new (this._getAjaxReqClass(C))(B).send();
    ...
    xhrQueuedGet: function (E, D, C, A) {
        C._mfInternal.xhrOp = "xhrQueuedGet";
        var B = this._getArguments(E, D, C, A);
        B.ajaxType = "GET";
        this._q.enqueue(new (this._getAjaxReqClass(C))(B));
    },
    multipartPost: function (E, D, C, A) {
        C._mfInternal.xhrOp = "multipartPost";
        var B = this._getArguments(E, D, C, A);
        delete B.xhrQueue;
        new (this._getMultipartReqClass(C))(B).send();
    },
    multipartGet: function (E, D, C, A) {
        C._mfInternal.xhrOp = "multiPartGet";
        var B = this._getArguments(E, D, C, A);
        B.ajaxType = "GET";
        delete B.xhrQueue;
        new (this._getMultipartReqClass(C))(B).send();
    ...
    multipartQueuedGet: function (E, D, C, A) {
        C._mfInternal.xhrOp = "multipartQueuedGet";
        var B = this._getArguments(E, D, C, A);
        B.ajaxType = "GET";
        this._q.enqueue(new (this._getMultipartReqClass(C))(B));
    },
...
_MF_SINGLTN(_PFX_CORE + "Impl", _MF_OBJECT, {
    ...
    STD_VALUES: [this.P_PARTIAL_SOURCE, this.P_VIEWSTATE, this.P_CLIENTWINDOW, this.P_AJAX, this.P_EXECUTE, this.P_RENDER, this.P_EVT, this.P_BEHAVIOR_EVENT, this.P_WINDOW_ID, this.P_RESET_VALUES],
    ERROR: "error",
    EVENT: "event",
    BEGIN: "begin",
    COMPLETE: "complete",
    ...
    request: function (P, L, E) {
        ...
        var O = this._Lang,
            F = this._Dom,
            J = myfaces._impl.xhrCore._AjaxUtils;
        O.assertType(E.onerror, "function");
        O.assertType(E.onevent, "function");
        E = E || {};
        if ("undefined" == typeof L) {
            L = window.event || null;
        }
        if (!P) {
            throw O.makeException(new Error(), "ArgNotSet", null, this._nameSpace, "request", O.getMessage("ERR_MUST_BE_PROVIDED1", "{0}: source  must be provided", "jsf.ajax.request", "source element id"));
        }
        var N = P;
        P = F.byIdOrName(P);
        if (!P) {
            throw O.makeException(new Error(), "Notfound", null, this._nameSpace, "request", O.getMessage("ERR_PPR_UNKNOWNCID", "{0}: Node with id {1} could not be found from source", this._nameSpace + ".request", N));
        }
        var H = F.nodeIdOrName(P);
        var K = O.mixMaps({}, E, true, this._BLOCKFILTER);
        if (E.params) {
            K = O.mixMaps(K, E.params, true, {});
        }
        if (L) {
            K[this.P_EVT] = L.type;
        }
        var C = { source: P, onevent: E.onevent, onerror: E.onerror, viewId: "", myfaces: E.myfaces, _mfInternal: {} };
        var D = C._mfInternal;
        var B = E.myfaces && E.myfaces.form ? O.byId(E.myfaces.form) : this._getForm(P, L);
        C.viewId = this.getViewId(B);
        J._assignNamingContainerData(D, B, jsf.separatorchar);
        var A = jsf.getClientWindow(B);
        if ("undefined" != typeof A && null != A) {
            var I = F.getNamedElementFromForm(B, J._$ncRemap(D, this.P_CLIENTWINDOW));
            if (I) {
                C._mfInternal._clientWindow = jsf.getClientWindow(B);
            } else {
                K[this.P_CLIENTWINDOW] = jsf.getClientWindow(B);
            }
        }
        K[this.P_PARTIAL_SOURCE] = H;
        K[this.P_AJAX] = true;
        if (E.resetValues === true) {
            K[this.P_RESET_VALUES] = true;
        }
        if (E.execute) {
            E.execute = E.execute.indexOf("@this") == -1 ? E.execute : E.execute;
            this._transformList(K, this.P_EXECUTE, E.execute, B, H, C.viewId);
        } else {
            K[this.P_EXECUTE] = H;
        }
        if (E.render) {
            this._transformList(K, this.P_RENDER, E.render, B, H, C.viewId);
        }
        var G = this._getTransportType(C, K, B);
        D["_mfSourceFormId"] = B.id;
        D["_mfSourceControlId"] = H;
        D["_mfTransportType"] = G;
        K[B.id] = B.id;
        var M = Object.keys(K);
        for (var R in M) {
            if (!Object.hasOwnProperty(R) || this.STD_VALUES.indexOf(R) == -1) {
                continue;
            }
            K[J._$ncRemap(D, R)] = K[R];
            delete K[R];
        }
        var Q = E.delay || this._RT.getLocalOrGlobalConfig(C, "delay", false);
        if (!!Q) {
            if (!(Q >= 0)) {
                throw new Error("Invalid delay value: " + Q);
            }
            if (this._delayTimeout) {
                clearTimeout(this._delayTimeout);
            }
    ...
    _getForm: function (E, D) {
        ...
        if (!B && D) {
            ...
            if (!B) {
                throw A.makeException(new Error(), null, null, this._nameSpace, "_getForm", A.getMessage("ERR_FORM"));
            }
        } else {
            if (!B) {
                throw A.makeException(new Error(), null, null, this._nameSpace, "_getForm", A.getMessage("ERR_FORM"));
    ...
    _getTransportType: function (B, I, A) {
        var J = this._RT.getLocalOrGlobalConfig,
            E = this._Lang,
            H = this._Dom;
        var D = J(B, "transportAutoSelection", true);
        if (!D) {
            return J(B, "transportType", "xhrQueuedPost");
        }
        var F = H.isMultipartCandidate(!J(B, "pps", false) ? A : I[this.P_EXECUTE]);
        var G = (H.getAttribute(A, "enctype") || "").toLowerCase() == "multipart/form-data";
        if (F && !G) {
            throw E.makeException(new Error(), null, null, this._nameSpace, "_getTransportType", E.getMessage("ERR_NO_MULTIPART_FORM", "No Multipart form", A.id));
        }
        var C = F && G;
        var K = !C ? J(B, "transportType", "xhrQueuedPost") : J(B, "transportType", "multipartQueuedPost");
        if (!this._transport[K]) {
            throw new Error(E.getMessage("ERR_TRANSPORT", null, K));
        }
        return K;
    },
    _transformList: function (K, I, C, A, G, E) {
        var D = this._Lang;
        C = this._Lang.trim(C);
        var F = 1,
            L = C ? C.split(/\s+/) : [],
            J = L.length ? D.arrToMap(L, F) : {},
            M = J[this.IDENT_NONE],
            N = J[this.IDENT_ALL],
            B = J[this.IDENT_THIS],
            H = J[this.IDENT_FORM];
        if (M) {
            if ("undefined" != typeof K.target) {
                delete K.target;
            }
            return K;
        }
        ...
        K[I] = this._remapNamingContainer(G, A, E, L).join(" ");
        return K;
    },
    _remapNamingContainer: function (D, F, E, G) {
        var A = jsf.separatorchar;
        function C(L) {
            var O = "";
            var I = E.length ? E + A : O;
            var P = F.id;
            var H = P.substring(0, P.lastIndexOf(A));
            var K = H.length ? H + A : O;
            var J = L.indexOf(A) === 0;
            var M = J || (E.length && L.indexOf(I) == 0);
            if (M) {
                L = J ? L.substring(1) : L;
                L = L.indexOf(I) == 0 ? L.substring(I.length) : L;
                return [I, L].join(O);
            } else {
                if (P.indexOf(I) == 0) {
                    P = P.substring(I.length);
                }
                var N = L.indexOf(P) == 0;
                return N ? [I, L].join(O) : [K, L].join(O);
            }
        }
        for (var B = 0; B < G.length; B++) {
            G[B] = C(this._Lang.trim(G[B]));
        }
        return G;
    },
    ...
    sendError: function sendError(H, D, B, N, J, E, C) {
        var G = myfaces._impl._util._Lang;
        var M = G.getMessage("UNKNOWN");
        var P = {};
        var I = function () {
            return B && B === myfaces._impl.core.Impl.MALFORMEDXML ? G.getMessage("ERR_MALFORMEDXML") : "";
        };
        P.type = this.ERROR;
        P.status = B || M;
        P.errorName = N || M;
        ...
        try {
            P.source = D.source || M;
            P.responseCode = H.status || M;
            P.responseText = H.responseText || M;
            P.responseXML = H.responseXML || M;
        } catch (K) {}
        if (jsf.getProjectStage() === "Development") {
            P.errorMessage = P.errorMessage || "";
            P.errorMessage = E ? P.errorMessage + "\nCalling class: " + E : P.errorMessage;
            P.errorMessage = C ? P.errorMessage + "\n Calling function: " + C : P.errorMessage;
        }
        if (D["onerror"]) {
            D.onerror(P);
        }
        this._errListeners.broadcastEvent(P);
        if (jsf.getProjectStage() === "Development" && this._errListeners.length() == 0 && !D["onerror"]) {
            var A = "--------------------------------------------------------",
                O = myfaces._impl.core._Runtime.getGlobalConfig("defaultErrorOutput", console && console.error ? console.error : alert),
                F = [],
                L = G.hitch(F, F.push);
            J ? L(G.getMessage("MSG_ERROR_MESSAGE") + " " + J + "\n") : null;
            L(A);
            E ? L("Calling class:" + E) : null;
            C ? L("Calling function:" + C) : null;
            B ? L(G.getMessage("MSG_ERROR_NAME") + " " + B) : null;
            N && B != N ? L("Server error name: " + N) : null;
            L(I());
            L(A);
            L(G.getMessage("MSG_DEV_MODE"));
            O(F.join("\n"));
        }
    },
    ...
    getSeparatorChar: function () {
        ...
        var C = "separatorchar",
            E = false,
            B = myfaces._impl.core._Runtime.getGlobalConfig,
            F = document.getElementsByTagName("script");
        for (var D = 0; D < F.length && !E; D++) {
            if (F[D].src.search(/\/javax\.faces\.resource.*\/jsf\.js.*separator/) != -1) {
                E = true;
                var A = F[D].src.match(/separator=([^&;]*)/);
                this._separator = decodeURIComponent(A[1]);
            }
        }
        this._separator = B(C, this._separator || ":");
    ...
    getProjectStage: function () {
        if (!this._projectStage) {
            var D = "projectStage",
                ...
                F = myfaces._impl.core._Runtime.getGlobalConfig,
                B = null,
                H = false,
                I = { STG_PROD: 1, Development: 1, SystemTest: 1, UnitTest: 1 };
            for (var C = 0; C < A.length && !H; C++) {
                if (A[C] && A[C].src && A[C].src.search(/\/javax\.faces\.resource\/jsf\.js.*ln=javax\.faces/) != -1) {
    ...
    chain: function (A, B) {
        ...
        var G = this._Lang;
        var E = function (K) {
            throw Error("jsf.util.chain: " + G.getMessage(K));
        };
        var H = function (K, L) {
            if (K === true) {
                E(L);
        ...
        var C = "function";
        var F = G.isString;
        H(I < 2, "ERR_EV_OR_UNKNOWN");
        H(I < 3 && (C == typeof B || F(B)), "ERR_EVT_PASS");
        if (I < 3) {
            return true;
        }
        H("undefined" == typeof A, "ERR_SOURCE_DEF_NULL");
        H(C == typeof A, "ERR_SOURCE_FUNC");
        H(F(A), "ERR_SOURCE_NOSTR");
        H(C == typeof B || F(B), "ERR_EV_OR_UNKNOWN");
        for (var D = 2; D < I; D++) {
            var J;
            if (C == typeof arguments[D]) {
                J = arguments[D].call(A, B);
            } else {
                J = new Function("event", arguments[D]).call(A, B);
            }
            if (J === false) {
                return false;
            }
    ...
    stdErrorHandler: function (D, B, A) {
        if (this._threshold == "ERROR") {
            var E = A._mfInternal || {};
            var C = [];
            C.push(A.message);
            this.sendError(D, B, E.title || this.CLIENT_ERROR, E.name || A.name, C.join("\n"), E.caller, E.callFunc);
        }
    },
    getClientWindow: function (C) {
        var F = this._Lang.hitch(this, function (J) {
            var H = {};
            var G;
            var M = 0;
            for (var L = J.length - 1; L >= 0; L--) {
                var K = J[L];
                var N = this._Dom.getNamedElementFromForm(K, this.P_WINDOW_ID);
                var I = N ? N.value : null;
                if (I) {
                    if (M > 0 && "undefined" == typeof H[I]) {
        ...
        var D = C ? this._Dom.byId(C) : document.body;
        var B = this._Dom.findByTagName(D, "form");
        var A = F(B);
        return null != A ? A : E();
    },
    getViewId: function (B) {
        var C = this;
        var E = this._Dom.findAll(
            B,
            function (F) {
                return F.tagName === "INPUT" && F.type === "hidden" && (F.name || "").indexOf(C.P_VIEWSTATE) !== -1;
            },
            true
        );
        if (!E.length) {
        ...
        var A = E[0].id.split(jsf.separatorchar, 2)[0];
        var D = A.indexOf(this.P_VIEWSTATE) === -1 ? A : "";
        return B.id.indexOf(D) === 0 ? D : "";
    },
});
(function () {
...
if (!window.jsf) {
    var jsf = new (function () {
        ...
        this.implversion = 0;
        this.separatorchar = A();
        this.getProjectStage = function () {
            var B = myfaces._impl.core._Runtime.getGlobalConfig("jsfAjaxImpl", myfaces._impl.core.Impl);
            return B.getProjectStage();
        };
        this.getViewState = function (C) {
            var B = myfaces._impl.core._Runtime.getGlobalConfig("jsfAjaxImpl", myfaces._impl.core.Impl);
            return B.getViewState(C);
        };
        this.getClientWindow = function () {
            var B = myfaces._impl.core._Runtime.getGlobalConfig("jsfAjaxImpl", myfaces._impl.core.Impl);
            return arguments.length ? B.getClientWindow(arguments[0]) : B.getClientWindow();
        };
        function A() {
            var B = myfaces._impl.core._Runtime.getGlobalConfig("jsfAjaxImpl", myfaces._impl.core.Impl);
            return B.getSeparatorChar();
        }
    })();
    window.jsf = jsf;
}
...
if (!jsf.push) {
    jsf.push = new (function () {
        var C = window.location.protocol.replace("http", "ws") + "//";
        var H = 500;
        var D = 25;
        var K = "Expired";
        var I = {};
        ...
        function B(Q, P, R) {
            ...
            O.open = function () {
                ...
                N.onmessage = function (X) {
                    var W = JSON.parse(X.data);
                    for (var V = F[Q].length - 1; V >= 0; V--) {
                        var a = F[Q][V];
                ...
                N.onclose = function (U) {
                    if (!N || (U.code == 1000 && U.reason == K) || U.code == 1008 || !S || S >= D) {
                        var V = F[Q];
                        for (var T = V.length - 1; T >= 0; T--) {
                            var W = V[T];
                            G[W]["onclose"](U.code, R, U);
                        }
                    } else {
                        setTimeout(O.open, H * S++);
                    }
                };
            };
            O.close = function () {
        ...
        var L = this;
        this.init = function (O, P, R, U, Q, T, S, N) {
            T = J(T);
            if (!window.WebSocket) {
                T(-1, R);
                return;
            ...
            if (!G[O]) {
                G[O] = { channelToken: V, onopen: J(U), onmessage: J(Q), onclose: T, behaviors: S, autoconnect: N };
                if (!F[V]) {
                    F[V] = [];
                }
                F[V].push(O);
        ...
        this.open = function (N) {
            E(G[N]["channelToken"]).open();
        };
        this.close = function (N) {
            E(G[N]["channelToken"]).close();
        };
        function A(N) {
            if (N.indexOf("://") < 0) {
                var O = window.location.hostname + ":" + window.location.port;
                return C + O + N;
            } else {
                return N;
            }
        ...
        function E(O) {
            ...
            if (N) {
                ...
                throw new Error("Unknown channelToken: " + O);
            }
        }
        function J(N) {
            return typeof N !== "function" && (N = window[N] || function () {}), N;
        }
    })();
}
